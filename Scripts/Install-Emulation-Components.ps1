...
if ($Sysmon -eq $true){
    ...
    Invoke-WebRequest "http://raw.githubusercontent.com/olafhartong/sysmon-modular/master/sysmonconfig-research.xml" -OutFile "$installPath\Sysmon\sysmonconfig-research.xml"
